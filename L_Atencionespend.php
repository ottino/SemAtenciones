...
<table width="100%">
 <TR style="background-color:'.$td_color.'"> <td>
  ...
  <tr>
    ...
    <td style="width:60px"><th> <a href="Principal.php"/a> <img border="0" src="imagenes/Volver.ico" width="30" height="30"  align="top" /></th></td>
...
echo '<td align="left">'.substr($motivo,0,25).'</td>';
echo '<td align="left">'.$row["movil"].'</td></tr>';
