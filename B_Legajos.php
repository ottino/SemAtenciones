...
<BODY>
<?
echo titulo_encabezado ('Baja de Personal' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
while ($row=mysql_fetch_array($result))
{
 ...
 echo '<TR><TD>Fecha Nac.</TD><TD><input disabled="disabled" size= 10 type = "text" name = "cla_fecnac" value = "'.$fecalta.'" /></TD></TR>';
 ...
 echo '<TR><TD>Fecha Baja.</TD><TD>
      <input type="text" name="cla_fecbaja" id="cla_fecha" size="10" />
...
<INPUT name="SUBMIT" TYPE="submit" value="Dar de Baja"></FORM>
