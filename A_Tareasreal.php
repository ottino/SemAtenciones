...
<TITLE>A_Tareasreal.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Alta de Tareas Realizadas' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
$movil= '<select style="width:300px" name="movil" style="background-color:'.$se_color.'"><option value="0">Movil</option>';
...
<TD><input size= 12 type = "text" name = "cla_importe" /></TD>
