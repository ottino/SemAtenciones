...
<HTML>
<HEAD>
<TITLE>ABM_Mensajesarc.php</TITLE>
</HEAD>
...
echo '<table ><tr><td>';
     ...
     echo ' <td width="40" align="center" style="background-color:'.$td_color.'">
                     <label onclick="this.form.submit();" style="CURSOR: pointer" >
                      <img align="middle" alt=\'Correos vigentes\' src="imagenes/Mail05a.ico" width="50" height="50"/>
                     </label></td>';
     echo '</FORM></TD>';
...
if ($row["leido"] < 1)
 {
  ...
  echo '<input type="hidden" name= "vengo" value="2" >';
...
echo '<input type="hidden" name= "marcamensaje" value  = "'.$marcamensaje.'" >';
echo '<input type="hidden" name= "vengo" value="2R" >';
echo ' <td width="17" align="center" style="background-color:'.$td_color.'" >
                    <label onclick="this.form.submit();" style="CURSOR: pointer" >
                     <img align="middle" alt=\'Recuperar\' src="imagenes/782.ico" width="20" height="20"/>
                    </label>
                  </td>';
echo '</FORM>';
...
echo '<input type="hidden" name= "pasmensaje" value="'.$idmensaje.'" >';
echo '<input type="hidden" name= "marcamensaje" value  = "'.$marcamensaje.'" >';
echo '<input type="hidden" name= "vengo" value="2B" >';
echo ' <td width="17" align="center" style="background-color:'.$td_color.'" >
                    <label onclick="this.form.submit();" style="CURSOR: pointer" >
                     <img align="middle" alt=\'Eliminar\' src="imagenes/783.ico" width="20" height="20"/>
                    </label>
                  </td>';
echo '</FORM>';
