...
<TITLE>ABM_Guardias.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Guardias' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
ACTION="ABM_Guardias2.php">

<table width = "10%" align="left">
<TR>
<TD><? echo $legajos ?><? echo $vector_meses ?><? echo $vector_anios ?>
</TD>
<TD>&nbsp;
</TD>
</TR></table>
