...
<HTML>
<HEAD>
<TITLE>ABM_Mensajesbor.php</TITLE>
</HEAD>
...
echo '<table ><tr><td>';
     ...
     echo ' <td width="40" align="center" style="background-color:'.$td_color.'">
                     <label onclick="this.form.submit();" style="CURSOR: pointer" >
                      <img align="middle" alt=\'Eliminados\' src="imagenes/Mail05a.ico" width="50" height="50"/>
                     </label></td>';
     echo '</FORM></TD>';
...
if ($row["leido"] < 1)
 {
  ...
  echo '<input type="hidden" name= "vengo" value="3" >';
...
echo '<input type="hidden" name= "marcamensaje" value  = "'.$marcamensaje.'" >';
echo '<input type="hidden" name= "vengo" value="3R" >';
echo ' <td width="17" align="center" style="background-color:'.$td_color.'">
                    <label onclick="this.form.submit();" style="CURSOR: pointer" >
...
echo '<input type="hidden" name= "pasmensaje" value="'.$idmensaje.'" >';
echo '<input type="hidden" name= "marcamensaje" value  = "'.$marcamensaje.'" >';
echo '<input type="hidden" name= "vengo" value="3B" >';
echo ' <td width="17" align="center" style="background-color:'.$td_color.'">
                    <label onclick="this.form.submit();" style="CURSOR: pointer" >
