...
<TITLE>M_Tareasreal.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Mantenimiento Tareas Realizadas' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
<?
 ...
 echo '<TR><TD>Importe</TD><TD><input size= 12 type = "text" name = "cla_importe" value = "'.$importe.'"/></TD></TR>';
 echo '<input type="hidden" name= "tareal" value="'.$id.'" >';
 echo '</table>' ;
?>
