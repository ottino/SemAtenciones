...
<TITLE>ABM_Contratos0.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Listado de Contratos' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
<TR><TD><? echo '<input type="text" name="cla_fecha" id="cla_fecha" size="10" />
       <input type="button" id="lanzador" value="Fecha Límite Vto" onclick="calendario();"/>';?></td></tr>
