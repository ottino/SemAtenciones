...
<TITLE>M_Tareasconf.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Confirmación Tareas Pendientes' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
<?
 ...
 echo '<TR><TD>Importe</TD><TD><input size= 12 type = "text" name = "cla_importe" value = "0"/></TD></TR>';
 echo '<input type="hidden" name= "tarconf" value="'.$id.'" >';
 echo '</table>' ;
?>
