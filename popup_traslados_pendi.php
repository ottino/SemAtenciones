...
<table border="1" style="border:inherit" style=" font-family:\'Courier New\', Courier, monospace; font-size:12px">
  <tr>
   <td align="center" colspan="10" style=" background-color:'.$th_color.'">
    PENDIENTES
   <td>
  </tr>
  <tr>
   ...
   <td width="17" valign="top" style=" background-color:'.$th_color.'">A</td>
   <td width="17" valign="top" style=" background-color:'.$th_color.'">E</td>
  </tr>
';
                ...
                <tr>
                  ...
                  <td width="17" valign="top" style="background-color:'.$td_color.'" style="background-color:'.$td_color.'" style="CURSOR: hand" >
                   <label onClick="window.open(\'online_anulaciones.php?id_atencion=\'+\''.ltrim($fila['id'] , '0').'\',
                                                \'ANULACIONES\', \'width=480,height=140,scrollbars=yes\');" >
