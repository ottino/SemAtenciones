...
<html>
 <head>
  ...
  <body onload="load_func(); document.formulario.prueba.focus(); '.$check.';" style="background-color:'.$body_color.' ;  font-size:'.$fontdef.' ; '.$font_family.'">
  ...
  <table width="80%" border="0" valign="top" style="font-size:'.$fontdef.'">
   <tr>
    <td align="left">LLAMADO <input name="legajo" type="text" disabled="disabled" value="'.$idemergencia_temp.'" size="10" />
    </td>
    <td>
    <table>
     <tr>
...
<table width="100%" border="0" style = "font-size:'.$fontdef.'">
 <tr>
  <td style=" background-color:'.$td_color.'">DIAGNOSTICO</td><td style=" background-color:'.$td_color.'">DESTINO</td><td style=" background-color:'.$td_color.'">COLORES</td>
    <td><input type="checkbox" name="prueba" size="1px"/></td>
 </tr>
 <tr>
  <td valign="top">
   <table>
    <tr>
    <td><div id="input_busca_diagnostico_div"></div></td><td><div id="lista_diagnostico"></div></td>
    </tr>
   </table>
  </td>
  <td valign="top">
