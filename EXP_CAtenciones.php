...
<TITLE>EXP_CAtenciones.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Exportar Atenciones a Excel' , $path_imagen_logo);
$segmenu = valida_menu();
//if ($segmenu <> "OK")
...
<TD><? echo $planes ?></td></tr>
 ...
 <TR><TD><? echo '<input type="text" size = 10 name="cla_idatencion"/>
         <input type="button" value="ID Atención"/>'; ?></td></tr>

</TD>
<TR></TR><TR></TR><TR></TR><TR><TD>Ordenado por: </TD></TR>
<TD><label>
        ...
        NOMBRE</label></td><TD><INPUT TYPE="SUBMIT" value="Exportar"></TD>
