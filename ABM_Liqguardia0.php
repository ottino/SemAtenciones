...
<TITLE>ABM_Liqguardia0.php</TITLE>
</HEAD>
<BODY>

<?
echo titulo_encabezado ('Consulta de Liquidaciones Guardias' , $path_imagen_logo);
$segmenu = valida_menu();
if ($segmenu <> "OK")
...
<TR>
 ...
 <TR><TD><? echo '<input type="text" size = 50 name="cla_nombre"/>
         <input type="button" value="Médico"/>'; ?></td></tr>

 <TR><TD><? echo '<input type="text" size = 10 name="cla_idguardia"/>
         <input type="button" value="ID Guardia"/>'; ?></td></tr>
