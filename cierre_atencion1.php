...
<html>
 <head>
  ...
  <body onload="load_func();'.$check.';" style="background-color:'.$body_color.' ;  font-size:'.$fontdef.' ; '.$font_family.'">
  ...
  <table align="center" border="0">
    ...
    <tr>
     <td valign="top"  colspan="2">
       <textarea id="text_obs_final" name="text_obs_final" cols="70" rows="10"></textarea>
     </td>
