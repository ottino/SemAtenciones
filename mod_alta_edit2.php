...
while ($fila=mysql_fetch_array ($consulta_vinculados))
 {
    $_FILAVINC.='
              <tr>
                    ...
                    <td width="10%"><input disabled="disabled" id="no_socio_'.$numero_vinc.'" type="text" value = "'.elimina_caracteres(htmlentities($fila['nombre'])).'" size="40%"/></td>  <td>&nbsp;</td>
                    <td><input  disabled="disabled" id="no_edad_'.$numero_vinc.'" type="text" value = "'.elimina_caracteres(htmlentities($fila['edad'])).'" size="4%" /></td>
                    <td><input  disabled="disabled" id="no_sexo_'.$numero_vinc.'" type="text" value = "'.elimina_caracteres(htmlentities($fila['sexo'])).'" size="4%" /></td><td>&nbsp;</td>
                    <td><input  disabled="disabled" id="no_iden_'.$numero_vinc.'" type="text" value = "'.elimina_caracteres(htmlentities($fila['os'])).'"  size="40%" /></td>
                    <td><input  disabled="disabled" id="no_docum_'.$numero_vinc.'" type="text" value = "'.elimina_caracteres(htmlentities($fila['dni'])).'" size="30%" /></td>
              </tr>
               ';
    $numero_vinc++;
 }
...
for ($c=0 ; $c <= $cantidad_vinculos ; $c++)
          {
           $_FILAVINC.='
                      <tr>
                            <td width="4%"><input disabled="disabled" id="nosocioid'.$numero_vinc.'" value="" type="hidden"  size="2%"/></td>
                            <td width="10%"><input disabled="disabled" id="no_socio_'.$numero_vinc.'" type="text" size="40%"/></td>  <td>&nbsp;</td>
                            <td><input disabled="disabled" id="no_edad_'.$numero_vinc.'"    type="text"  size="4%"/></td>
                            <td><input disabled="disabled" id="no_sexo_'.$numero_vinc.'"    type="text"  size="4%"/></td> <td>&nbsp;</td>
                            <td><input disabled="disabled" id="no_iden_'.$numero_vinc.'"    type="text" size="40%"/></td>
                            <td><input  disabled="disabled" id="no_docum_'.$numero_vinc.'"  type="text" size="30%"/></td>
                      </tr>
                       ';
            $numero_vinc++;
          }
...
{
       $consulta_planes = mysql_query("SELECT * FROM planes WHERE estado <> 'B' order by 2");
...
<table border="0" bordercolor="#FFFFFF" align="center" width="996" valign="top" style="font-size:'.$fontdef.'">
 ...
 <table  border="0" bordercolor="#FFFFFF" align="center" width="996" height="100">
 <tr>
...
<table align="left" width="100%" border="0">
  <tr>
    ...
    <td valign="top" width="95%"><input  type="text" name="obs1" value="'.elimina_caracteres(htmlentities($atencion_datos_edit['observa1'])).'" size="60%"/><br>
    <input  type="text" name="obs2" value="'.elimina_caracteres(htmlentities($atencion_datos_edit['observa2'])).'" size="60%"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
